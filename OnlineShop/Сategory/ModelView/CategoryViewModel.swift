...
class CategoryViewModel {
    ...
    //MARK: Intent(s)
    func showNextController(subCategory: [Subcategory], title: String) -> SubCategoryViewController {
        return model.showSubCategories(subCategory: subCategory, title: title)
    }
}
